...
public class InventarioController {
    ...
    @GetMapping("/{hacienda}")
    public ResponseEntity<List<HistorialVenta>> devolverInventarioByHacienda(@PathVariable("hacienda") int hacienda, @RequestParam(value = "temporada", required = true) int idtemporada) {
        List<HistorialVenta> inventario = inventarioService.getPedidosPendientesHacienda(hacienda, idtemporada);
        return new ResponseEntity<>(inventario, HttpStatus.OK);
    }
